...
import org.example.one_to_many_unidirectional_no_cascade.mapper.TeacherDepartmentMapper;
import org.example.one_to_many_unidirectional_no_cascade.model.Department;
import org.example.one_to_many_unidirectional_no_cascade.model.DepartmentsToTeacherDto;
...
public class TeacherService {
    ...
    public TeacherDto saveTeacher(TeacherDto teacher) {
        ...
        // teacher already has reference to the list of departments
        List<Department> departments = departmentRepository.saveAll(newTeacher.getDepartments());
