package org.example.one_to_many_bidirectional_with_cascade.service;

import org.example.one_to_many_bidirectional_with_cascade.dto.TeacherDto;
import org.example.one_to_many_bidirectional_with_cascade.mapper.TeacherDepartmentMapper;
import org.example.one_to_many_bidirectional_with_cascade.model.Department;
import org.example.one_to_many_bidirectional_with_cascade.model.DepartmentsToTeacherDto;
import org.example.one_to_many_bidirectional_with_cascade.model.Teacher;
import org.example.one_to_many_bidirectional_with_cascade.respository.DepartmentRepository;
import org.example.one_to_many_bidirectional_with_cascade.respository.TeacherRepository;
...
public class TeacherService {
    ...
    public TeacherDto saveTeacher(TeacherDto teacher) {
        ...
        List<Department> departments = newTeacher.getDepartments();
        // if don't set Teacher on departments before save, it will create the children but with no link to parent
        departments.forEach(elem -> elem.setTeacher(newTeacher));
